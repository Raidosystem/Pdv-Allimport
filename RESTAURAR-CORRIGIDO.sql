-- =============================================
-- RESTAURA��O COM EMPRESA_ID CORRETO
...
INSERT INTO clientes (
  ...
  'f7fdf4cf-7101-45ab-86db-5248a7ac58c1',
  'f7fdf4cf-7101-45ab-86db-5248a7ac58c1',
  'marco aur�lio becari ',
  '17997070468',
  '',
  '18184335830',
  '18184335830',
  'av 13a, 211 s�o francisco ',
  'gua�ra',
  'sp',
  '14790000',
  'fisica',
...
INSERT INTO clientes (
  ...
  '65744138/0001-40',
  '65744138000140',
  'av jo�o jorge garcia leal, 0601 - parque industrial',
  'gua�ra',
  'sp',
  '14790000',
  'fisica',
...
-- 64/141: jo�o batista serafim gon�alves
INSERT INTO clientes (
  id, user_id, empresa_id, nome, telefone, email, cpf_cnpj, cpf_digits,
  endereco, cidade, estado, cep, tipo, ativo, observacoes,
  created_at, updated_at
  ...
  'f7fdf4cf-7101-45ab-86db-5248a7ac58c1',
  'f7fdf4cf-7101-45ab-86db-5248a7ac58c1',
  'jo�o batista serafim gon�alves',
  '999742270',
  '',
  '05256498835',
  '05256498835',
...
-- 75/141: ADRIAN RENAN GON�ALVES PEREIRA
INSERT INTO clientes (
  id, user_id, empresa_id, nome, telefone, email, cpf_cnpj, cpf_digits,
  endereco, cidade, estado, cep, tipo, ativo, observacoes,
  created_at, updated_at
  ...
  'f7fdf4cf-7101-45ab-86db-5248a7ac58c1',
  'f7fdf4cf-7101-45ab-86db-5248a7ac58c1',
  'ADRIAN RENAN GON�ALVES PEREIRA',
  '16994008655',
  '',
  '50039370836',
  '50039370836',
...
-- 76/141: JO�O VITOR RIBEIRO DOS REIS
INSERT INTO clientes (
  id, user_id, empresa_id, nome, telefone, email, cpf_cnpj, cpf_digits,
  endereco, cidade, estado, cep, tipo, ativo, observacoes,
  created_at, updated_at
...
-- 82/141: mMARIA BENEDITA DE ALMEIDA FOGA�A
INSERT INTO clientes (
  id, user_id, empresa_id, nome, telefone, email, cpf_cnpj, cpf_digits,
  endereco, cidade, estado, cep, tipo, ativo, observacoes,
  created_at, updated_at
  ...
  'f7fdf4cf-7101-45ab-86db-5248a7ac58c1',
  'f7fdf4cf-7101-45ab-86db-5248a7ac58c1',
  'mMARIA BENEDITA DE ALMEIDA FOGA�A',
  '43991784929',
  '',
  '4968350991',
  '4968350991',
...
-- 117/141: joao batista serafim gon�alves
INSERT INTO clientes (
  id, user_id, empresa_id, nome, telefone, email, cpf_cnpj, cpf_digits,
  endereco, cidade, estado, cep, tipo, ativo, observacoes,
  created_at, updated_at
  ...
  'f7fdf4cf-7101-45ab-86db-5248a7ac58c1',
  'f7fdf4cf-7101-45ab-86db-5248a7ac58c1',
  'joao batista serafim gon�alves',
  '17999792270',
  '',
  '05256498835',
  '05256498835',
...
INSERT INTO clientes (
  ...
  '323.455.568-03',
  '32345556803',
  'rua 7c n 117 - residencial am�lia ',
  'gua�ra',
  'sp',
  '14790-000',
  'fisica',
