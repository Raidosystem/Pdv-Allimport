-- VERSÃO MELHORADA: Função de renovação com logs detalhados
-- Execute este script no SQL Editor do Supabase para substituir a função atual
...
BEGIN
  ...
  GET DIAGNOSTICS subscription_found = FOUND;
