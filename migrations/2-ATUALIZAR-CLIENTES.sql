-- =============================================
-- ATUALIZAÇÃO COMPLETA DE DADOS (UPSERT)
-- Gerado automaticamente em 19/10/2025, 23:37:37
-- Trata conflitos de ID e CPF duplicados
-- =============================================
...
-- Trata conflitos de ID e CPF_DIGITS
-- =============================================

-- Cliente: ANTONIO CLAUDIO FIGUEIRA
-- Deletar duplicados por CPF (se existirem)
...
-- Cliente: ALINE CRISTINA CAMARGO
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: WINDERSON RODRIGUES LELIS
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: ALINE MARIA PEREIRA DA CRUZ
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: JORGE FRANCISCO RIBEIRO
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: JOSLIANA ERIDES DE PAULA FREITAS
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: FLAVIA MARQUES FIGUEIREDO DE PAULA
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: ODAIR FERREIRA DE SOUSA
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: Sirlene Janaina Amancio
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: ADRIANA DA SILVA CIPRIANO
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: MARISSELMA DE OLIVEIRA BORGES
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: maria vitoria medeiros
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: DOUGLAS RODRIGUES FERREIRA
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: JULIANA ALVES DE SOUZA
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: GABRIEL VICTOR DOS SANTOS
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: raimundo da silva barcelar
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: gabriela domiciano soares
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: Aguetoni Transportes LTDA
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: WILSON JOSE SERIBELI JUNIOR
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: ROBERTO CARLOS  OLIVEIRA SILVA 
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: VANESIO MARTINS GUEDES
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: liliane maria dos santos
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: JOEMERSON SILVEIRA DOS SANTOS
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: joão batista serafim gonçalves
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: larissa de oliveira espacini
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: rogerio basilio de araujo
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: BEATRIZ DE SOUZA DA SILVA
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: ANA CAROLNA SANTOS DE OLIVEIRA
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: ADRIAN RENAN GONÇALVES PEREIRA
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: JOÃO VITOR RIBEIRO DOS REIS
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: RENATA CRISTINA CAETANO
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: mMARIA BENEDITA DE ALMEIDA FOGAÇA
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: Roseli Lacerda Cartola
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: DANIELE CUSTODIO DE MELO
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: RAQUEL APARECIDA GOMES
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: EDSON GUILHERME FONSECA
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: Altamiro Antonio de Matos
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: Pedro Henrique Eugenio
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: jennifer maria de sousa
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: TARINAN GOMES DOS SANTOS
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: mirela vitoria ferreira de sousa
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: ana paula garcia barbosa
INSERT INTO clientes (
  id, empresa_id, nome, telefone, email, cpf_cnpj, cpf_digits,
  endereco, cidade, estado, cep, tipo, ativo, observacoes,
  created_at, updated_at
...
-- Cliente: ELAINE CRISTINA RIBEIRO
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: LUIZ FABIO TALARICO DE OLIVEIRA
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: daltoni da cunha teixeira
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: valeria cristina da costa 
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: SULAMITA FERREIRA DE SOUZA
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: joao batista serafim gonçalves
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
WHERE cpf_digits = '05256498835'
  AND empresa_id = 'f1726fcf-d23b-4cca-8079-39314ae56e00'
...
-- Cliente: IRENE ROSA DE SOUZA VALENTI
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: FERNANDA MARQUES DA SILVA CANDIDO
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: gabriel alves scarpelini dos santos
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: CRISTIANE APARECIDA SOUZA FERRAZ
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: CARLOS DA SILVA BARBOSA
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: VALESCA RUBIA PAIVA TOLENTINO
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: andrea da silva brosco
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Cliente: daniel rosa de oliveira
-- Deletar duplicados por CPF (se existirem)
DELETE FROM clientes 
...
-- Verificar clientes atualizados
SELECT 
  'clientes' as tabela,
  COUNT(*) as total,
