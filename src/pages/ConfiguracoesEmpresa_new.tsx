...
function PermissoesForm({
  ...
  const permissoesList = [
    { key: 'vendas', label: 'Vendas', description: 'Realizar vendas e consultar histórico' },
    { key: 'produtos', label: 'Produtos', description: 'Gerenciar produtos e estoque' },
    { key: 'clientes', label: 'Clientes', description: 'Gerenciar cadastro de clientes' },
    { key: 'caixa', label: 'Caixa', description: 'Abrir/fechar caixa e consultar movimentação' },
    { key: 'ordens_servico', label: 'Ordens de Serviço', description: 'Gerenciar ordens de serviço' },
    { key: 'relatorios', label: 'Relatórios', description: 'Visualizar relatórios e gráficos' },
    { key: 'configuracoes', label: 'Configurações', description: 'Alterar configurações do sistema' },
    { key: 'funcionarios', label: 'Funcionários', description: 'Gerenciar funcionários (apenas proprietários)' },
  ] as const;
