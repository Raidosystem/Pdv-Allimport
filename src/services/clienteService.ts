...
export class ClienteService {
  ...
  static async buscarClientes(filtros: ClienteFilters = {}) {
    try {
      ...
      // BACKUP local desabilitado para garantir segurança multi-tenant
      const todosClientes = [...clientesSupabase]

      console.log(`📋 Clientes encontrados: ${clientesSupabase.length} do Supabase = ${todosClientes.length} total`)
